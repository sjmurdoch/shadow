...
extern uint8_t chanid_circid_muxinfo_map_PRIMES[104];
...
extern uint8_t n_channels_allocated[8];
...
extern uint8_t first_hop_notice_limit[24];
extern uint8_t CLIENT_CIPHER_STACK[8];
extern uint8_t cell_pool[8];
extern uint8_t channel_identity_map[8];
...
extern uint8_t chanid_circid_muxinfo_map_N_PRIMES[4];
...
extern uint8_t crypto_openssl_version_str[8];
...
extern uint8_t n_openssl_mutexes_[4];
...
extern uint8_t _last_circid_chan_ent[8];
...
extern uint8_t finished_channels[8];
extern uint8_t num_cpus[4];
extern uint8_t active_listeners[8];
...
extern uint8_t buf13[64];
extern uint8_t chan_circid_map_N_PRIMES[4];
...
extern uint8_t circuits_pending_chans[8];
...
extern uint8_t escaped_val_[8];
extern uint8_t finished_listeners[8];
...
extern uint8_t crypto_global_initialized_[4];
extern uint8_t chan_circid_map_PRIMES[104];
extern uint8_t key_lock[8];
extern uint8_t server_identitykey[8];
extern uint8_t chan_circid_map[24];
