...
void scallion_register_globals(PluginFunctionTable* scallionFuncs, Scallion* scallionData) {
	scallionData->shadowlibFuncs->registerPlugin(scallionFuncs, 447,
		...
		(gsize) 0x68, (gpointer) &chanid_circid_muxinfo_map_PRIMES,
		...
		(gsize) 0x8, (gpointer) &n_channels_allocated,
		...
		(gsize) 0x4, (gpointer) &log_global_min_severity_,
		...
		(gsize) 0x18, (gpointer) &first_hop_notice_limit,
		(gsize) 0x8, (gpointer) &CLIENT_CIPHER_STACK,
		(gsize) 0x8, (gpointer) &cell_pool,
		(gsize) 0x8, (gpointer) &channel_identity_map,
		...
		(gsize) 0x4, (gpointer) &chanid_circid_muxinfo_map_N_PRIMES,
		...
		(gsize) 0x8, (gpointer) &crypto_openssl_version_str,
		...
		(gsize) 0x4, (gpointer) &n_openssl_mutexes_,
		...
		(gsize) 0x8, (gpointer) &_last_circid_chan_ent,
		...
		(gsize) 0x8, (gpointer) &finished_channels,
		(gsize) 0x4, (gpointer) &num_cpus,
		(gsize) 0x8, (gpointer) &active_listeners,
		...
		(gsize) 0x40, (gpointer) &buf13,
		(gsize) 0x4, (gpointer) &chan_circid_map_N_PRIMES,
		...
		(gsize) 0x8, (gpointer) &circuits_pending_chans,
		...
		(gsize) 0x8, (gpointer) &escaped_val_,
		(gsize) 0x8, (gpointer) &finished_listeners,
		...
		(gsize) 0x4, (gpointer) &crypto_global_initialized_,
		(gsize) 0x68, (gpointer) &chan_circid_map_PRIMES,
		(gsize) 0x8, (gpointer) &key_lock,
		(gsize) 0x8, (gpointer) &server_identitykey,
		(gsize) 0x18, (gpointer) &chan_circid_map,
		...
		(gsize) 0x8, (gpointer) &all_channels,
